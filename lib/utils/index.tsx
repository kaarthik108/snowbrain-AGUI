...
export function Template({ context }: { context: string }) {
  return `
You're an AI assistant specializing in data analysis with Snowflake SQL. Provide me with a SQL query based on the context which details about the snowflake schema details. 
